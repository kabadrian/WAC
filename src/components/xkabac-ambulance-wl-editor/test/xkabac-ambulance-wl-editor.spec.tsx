...
describe('xkabac-ambulance-wl-editor', () => {
  ...
  it('buttons shall be of different type', async () => {
    ...
    const page = await newSpecPage({
      ...
      html: `<xkabac-ambulance-wl-editor entry-id="test-entry"
                ambulance-id="test-ambulance" api-base="https://sample.test/api">
  ...
  it('first text field is patient name', async () => {
    ...
    const page = await newSpecPage({
       components: [XkabacAmbulanceWlEditor],
       html: `<xkabac-ambulance-wl-editor entry-id="test-entry" ambulance-id="test-ambulance" api-base="http://sample.test/api"></xkabac-ambulance-wl-editor>`,
    });
